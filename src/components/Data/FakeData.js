const services = [
    {
        ...
        price : 50,
        description : 'Napa (Paracetamol) is a fast acting and safe analgesic with marked antipyretic property. '
    },
    {
        name : 'peracitemol',
        id : 2,
    ...
    },
    {
        ...
        price : 75,
        decription : 'The usual initial dose of Comprid™ is 40 to 80 mg daily, gradually increased, if necessary up to 320 mg daily until adequate control is achieved.'
    },
    {
        name : 'Cough Syrup',
        id : 4,
        ...
        price : 40,
        decription : 'This combination medication is used to relieve coughs caused by the common cold, bronchitis, and other breathing illnesses'
    },
    {
        name : 'Flexi',
        id : 5,
        ...
        price : 54,
        description : 'Flexi 4mg Tablet is an antiemetic medicine commonly used to control nausea and vomiting due to certain medical conditions like stomach upset. '
    },
    {
        name : 'Sitagil',
        id : 6,
        ...
        price : 68,
        description: 'Sitagliptin is a DPP-4 inhibitor, which is believed to exert its actions in patients with type 2 diabetes by slowing the inactivation of incretin hormones.'
    },
    {
        name : 'Neotack',
        id : 7,
        ...
        price : 71,
        description : 'Tablet Neotack Tablet · Duodenal and gastric ulcer: The usual dosage is 150 mg twice daily taken in the morning and evening or 300 mg as a single daily dose'
    },
    {
        name : 'Menaril',
        id : 8,
        ...
        price : 31,
        description : 'Betahistine is indicated for the treatment of Menieres syndrome, symptoms of which may include vertigo, tinnitus, hearing loss and nausea.'
    },
    {
        name : 'Domilux',
        id : 9,
        ...
        price : 50,
        description : 'Domilux Tablet 10 mg (10pcs) ... almost no effect on the dopaminergic receptors in the brain, therefore excluding psychotropic and neurologic side effects.'
    },
]
